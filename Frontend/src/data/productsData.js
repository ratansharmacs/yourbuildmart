...
// Local uploaded product images (stored in DB via ProductImageSeeder)
// These images are uploaded directly to the project and referenced in the database
const LOCAL_IMAGES = {
  steelSheet: [
    "/src/assets/uploads/products/steel_sheet_1.jpg",
    "/src/assets/uploads/products/steel_sheet_2.jpg",
    "/src/assets/uploads/products/steel_sheet_3.jpg",
  ],
  butterflyValves: [
    "/src/assets/uploads/products/butterfly_valve_1.png",
    "/src/assets/uploads/products/butterfly_valve_2.png",
    "/src/assets/uploads/products/butterfly_valve_3.png",
    "/src/assets/uploads/products/butterfly_valve_4.png",
  ],
};

export const ALL_PRODUCTS = [
  { id: 54, name: "Steel Sheet",                              img: LOCAL_IMAGES.steelSheet[0],      additionalImages: LOCAL_IMAGES.steelSheet,      href: "/productDetail", category: "Steel Sections",       tag: "ISO Certified"   },
  { id: 52, name: "Butterfly Valves",                         img: LOCAL_IMAGES.butterflyValves[0], additionalImages: LOCAL_IMAGES.butterflyValves,  href: "/productDetail", category: "Industrial Valves",    tag: "Global Delivery"  },
